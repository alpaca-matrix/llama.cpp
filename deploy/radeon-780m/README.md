...
| Slot | Model | Why |
|---|---|---|
| `fast` | nerkyor Qwen3.6-35B-A3B-DSV4Pro-Thinking-Distill + mmproj | all-rounder: reasoning, vision and tools in 20.22 GiB; took the alias 2026-08-04, see `candidates.md` |
